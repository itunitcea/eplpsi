            ...
            <fieldset>
                ...
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">          
                            <input type="Text" class="form-control" id="product_byproducts_name" placeholder="Enter Products Byproducts Name" name="product_byproducts_name">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-3" for="qty">Quantity :</label>
                        <div class="col-sm-9">          
                            <input type="Text" class="form-control" id="qty" placeholder="Enter Products Byproducts Quantity" name="qty">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-3" for="productstatus">Product Status :</label>
                        <div class="col-sm-9">          
                            <input type="Text" class="form-control" id="prdStatus" placeholder="Enter Product Status" name="productstatus">
                        </div>
                    </div>
                    <br/>
                    <div>
            ...
            <fieldset>
                ...
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">          
                            <input type="Text" class="form-control" id="rawName" placeholder="Enter Raw Meterials Name " name="materialname">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="qty">Quantity :</label>
                        <div class="col-sm-10">          
                            <input type="Text" class="form-control" id="qty" placeholder="Enter Raw Meterials Quantity" name="qty">
                        </div>
                    </div>
                    <br/>
                    <div>
            ...
            <fieldset>
                ...
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">          
                            <input type="Text" class="form-control" id="chemicalName" placeholder="Enter Chemical Name" name="chemicalname">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="brandName">Brand Name :</label>
                        <div class="col-sm-10">          
                            <input type="Text" class="form-control" id="brandName" placeholder="Enter Brand Name" name="trdename">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="qty">Quantity :</label>
                        <div class="col-sm-10">          
                            <input type="Text" class="form-control" id="qty" placeholder="Enter Products Byproducts Quantity" name="quantity">
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <br/>
            <fieldset>
                ...
                <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <textarea class="form-control" rows="5" id="Precautionarymeasures" name="precautionarymeasures"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <textarea class="form-control" rows="5" id="Storagefacilities" name="storage_facilities"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <textarea class="form-control" rows="5" id="fireEquipments" name="detailsofequip"></textarea>
                        </div>
                    </div>
                    <div>
                        <center>
