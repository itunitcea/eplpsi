...
<form class="form-horizontal" >
    ...
    <fieldset>
        <div class="form-group">
            ...
            <label class="col-sm-7 control-label" style="text-align: left">{{$industry->recycle}}</label>
        </div>
        
        <div>
            <center>
                <a class="glyphicon glyphicon-plus btn btn-warning" href="{{url('/recycle/'.$industry->industryID.'/edit')}}">Edit</a> 
